...
- The caller owns tool execution. A history ending in a `ToolResult` continues by deferral: the pending call is marked in the transcript, one result is held, and Claude collects it on resume.
